...
/////////////////
const BotName = 'Yare Yare Novan☄'; 
const instagram = 'https://instagram.com/ytkangcilok'; 

const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Kang Cilok';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ytkangcilok')
